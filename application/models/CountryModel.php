...
class CountryModel extends CI_Model {
    ...
    function getDataById($id){
        ...
        $categories = (object) [];
        if(!empty($row)){
            $query = $this->db->select('c.*')->from('country_category as sc')->join('category as c','c.category_id=sc.category_id','left')->where('sc.country_id',$row->id)->get();
    ...
    function create(){
        ...
        foreach($this->input->post('categories') as $val){
            ...
            $this->db->insert('country_category',$data);
        }
    ...
    function update(){
        ...
        $this->db->delete('country_category');
