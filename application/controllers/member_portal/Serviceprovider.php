<?php
    class Serviceprovider extends CI_Controller{
        function __construct(){
            parent::__construct();
            $this->load->model(MEMBERPATH.'serviceprovider_model','sprovider');
        ...
        function index(){
            ...
            if($this->input->post('action') == "change_publish"){
                if ($result = $this->sprovider->st_update()) {
                    ...
                    redirect(MEMBERPATH.'serviceprovider');
                }
            ...
            $this->load->view(MEMBERPATH.'sp/list',$data);
        }
        ...
        function add(){ 
            ...
            //     redirect('sp');
                ...
                $this->load->view(MEMBERPATH.'sp/add',$data); 
            }
        }
        ...
        function edit($id = 0){
            ...
            //         redirect('sp');
                ...
                $this->load->view(MEMBERPATH.'sp/edit',$data); 
            }
        }
        ...
        function view($id = 0){
            ...
            //         redirect('sp');
                ...
                // echo $this->uri->segment(3);exit;
                $data['form_data'] = $this->sprovider->getDataById($id);
                $this->load->view(MEMBERPATH.'sp/view',$data); 
            }
        }
        ...
        function document($id = 0){
            ...
            if(isset($_POST['submit'])){
                ...
                if ($result = $this->sprovider->document_save()) {
                    ...
                    redirect(MEMBERPATH.'serviceprovider/document/'.$id);
                }else{
                ...
                // echo $this->uri->segment(3);exit;
                $data['form_data'] = $this->sprovider->getDataById($id);
                $this->load->view(MEMBERPATH.'sp/document',$data); 
            }
        }
