    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <form name="dataTableForm" id="dataTableForm" action="<?=base_url().ADMIN;?>service" method="post" enctype="multipart/form-data">
                    <!-- Light table -->
                            ...
                            <tbody class="list">
                                <?php foreach($list as $key=>$val){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($val->image != ""){ ?>
                                                <img src="<?php echo base_url(SERVICE_IMG.$val->image); ?>" width="50"/>
                                            <?php } ?>
                                        </td>
