                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="" cols="30" rows="4" class="form-control"><?php echo $form_data->description; ?></textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 d-flex align-items-center pre-img-box">
                                    <img src="<?php echo base_url(VEHICLE_TYPE_IMG.$form_data->image); ?>" id="" class="img-fluid" />
                                </div>
                            </div>
                        </div>
