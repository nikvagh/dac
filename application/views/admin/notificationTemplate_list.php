                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <?php foreach($list as $key=>$val){ ?>
                                    <a class="mb-2 nav-link <?php if($key == 0){echo "active";} ?>" id="v-pills-<?php echo $val->heading_code; ?>-tab" data-toggle="pill" href="#v-pills-<?php echo $val->heading_code; ?>" role="tab" aria-controls="v-pills-<?php echo $val->heading_code; ?>" aria-selected="true"><?php echo $val->heading; ?></a>
                                <?php } ?>
                            </div>
                            <br>
                        ...
                        <div class="col-9">
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <?php foreach($list as $key=>$val){ ?>
                                    <div class="tab-pane fade show <?php if($key == 0){echo "active";} ?>" id="v-pills-<?php echo $val->heading_code; ?>" role="tabpanel" aria-labelledby="v-pills-<?php echo $val->heading_code; ?>-tab">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="notification_content" class="form-control" placeholder="Notification Content" rows="10"></textarea>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="mail_content_<?php echo $val->heading_code; ?>" id="mail_content_<?php echo $val->heading_code; ?>" class="form-control" placeholder="Mail Content"></textarea>
