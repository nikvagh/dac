                ...
                <div class="row">
                    <div class="col-2">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="mb-2 nav-link <?php if ($tab == "current") { echo 'active'; } ?> active" id="pill_current" data-toggle="pill" href="#pill_current_box" role="tab" aria-controls="v_pill_current_box" aria-selected="true">Current</a>
                            <a class="mb-2 nav-link <?php if ($tab == "waiting") { echo 'active'; } ?>" id="pill_waiting" data-toggle="pill" href="#pill_waiting_box" role="tab" aria-controls="v_pill_waiting_box" aria-selected="true">Waiting</a>
                            <a class="mb-2 nav-link <?php if ($tab == "active") { echo 'active'; } ?>" id="pill_active" data-toggle="pill" href="#pill_active_box" role="tab" aria-controls="v_pill_active_box" aria-selected="true">Active</a>
                            <a class="mb-2 nav-link <?php if ($tab == "completed") { echo 'active'; } ?>" id="pill_completed" data-toggle="pill" href="#pill_completed_box" role="tab" aria-controls="v_pill_completed_box" aria-selected="true">Completed</a>
                            <a class="mb-2 nav-link <?php if ($tab == "cancelled") { echo 'active'; } ?>" id="pill_cancelled" data-toggle="pill" href="#pill_cancelled_box" role="tab" aria-controls="v_pill_cancelled_box" aria-selected="true">Cancelled</a>
                                                    
                            <a class="mb-2 nav-link <?php if ($tab == "companyCoreSetting") {
                                                        echo 'active';
                                                    } ?>" id="v-pills-company_core_setting-tab" data-toggle="pill" href="#v-pills-company_core_setting" role="tab" aria-controls="v-pills-company_core_setting" aria-selected="true">Company Core Setting</a>
                            <a class="mb-2 nav-link <?php if ($tab == "paymentSetting") {
                                                        echo 'active';
                                                    } ?>" id="v-pills-payment_setting-tab" data-toggle="pill" href="#v-pills-payment_setting" role="tab" aria-controls="v-pills-payment_setting" aria-selected="true">Payment Setting</a>
                            <a class="mb-2 nav-link <?php if ($tab == "userVerificationSetting") {
                                                        echo 'active';
                                                    } ?>" id="v-pills-user_verification_setting-tab" data-toggle="pill" href="#v-pills-user_verification_setting" role="tab" aria-controls="v-pills-user_verification_setting" aria-selected="true">User Verification</a>
                            <a class="mb-2 nav-link <?php if ($tab == "notificationSetting") {
                                                        echo 'active';
                                                    } ?>" id="v-pills-notification_setting-tab" data-toggle="pill" href="#v-pills-notification_setting" role="tab" aria-controls="v-pills-notification_setting" aria-selected="true">Notification Setting</a>
                            <a class="mb-2 nav-link <?php if ($tab == "privacyPolicy") {
                                                        echo 'active';
                                                    } ?>" id="v-pills-privacy_policy-tab" data-toggle="pill" href="#v-pills-privacy_policy" role="tab" aria-controls="v-pills-privacy_policy" aria-selected="true">Privacy Policy</a>
                    ...
                    <div class="col-10">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active <?php if ($tab == "current") { echo 'show active'; } ?>" id="pill_current_box" role="tabpanel">
                                <div class="card shadow">
                                    <div class="card-body">

                                            <table class="table currentJobTbl" id="current">
                                                <thead>
                                                    <tr>
                                                        <th>Call #</th>
                                                        <th>Vehicle</th>
                            ...
                            <div class="tab-pane fade <?php if ($tab == "companyCoreSetting") {
                                                            echo 'show active';
                                                        } ?>" id="v-pills-company_core_setting" role="tabpanel" aria-labelledby="v-pills-company_core_setting-tab">
                                <div class="card shadow">
                                    <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" name="currency">
                                                            ...
                                                            <?php foreach ($currency_list as $key => $val) { ?>
                                                                <option value="<?php echo $val->id; ?>" <?php if ($val->id == $this->system->currency) {
                                                                                                            echo "selected";
                                                                                                        } ?>><?php echo $val->nicename . ' ' . $val->iso3 . ' (' . $val->currency . ')'; ?></option>
                                                            <?php } ?>
                                                        </select>
                            ...
                            <div class="tab-pane fade <?php if ($tab == "paymentSetting") {
                                                            echo 'show active';
                                                        } ?>" id="v-pills-payment_setting" role="tabpanel" aria-labelledby="v-pills-payment_setting-tab">
                                <div class="card shadow">
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="service_paid_locally" <?php if ($this->system->service_paid_locally == 'Yes') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="paypal" <?php if ($this->system->paypal == 'Yes') {
                                                                                                        echo 'checked';
                                                                                                    } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="stripe" <?php if ($this->system->stripe == 'Yes') {
                                                                                                        echo 'checked';
                                                                                                    } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="razorpay" <?php if ($this->system->razorpay == 'Yes') {
                                                                                                        echo 'checked';
                                                                                                    } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="flutterwave" <?php if ($this->system->flutterwave == 'Yes') {
                                                                                                            echo 'checked';
                                                                                                        } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="paystack" <?php if ($this->system->paystack == 'Yes') {
                                                                                                        echo 'checked';
                                                                                                    } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                            ...
                            <div class="tab-pane fade <?php if ($tab == "userVerificationSetting") {
                                                            echo 'show active';
                                                        } ?>" id="v-pills-user_verification_setting" role="tabpanel" aria-labelledby="v-pills-user_verification_setting-tab">
                                <div class="card shadow">
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="user_verification" <?php if ($this->system->user_verification == 'Yes') {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="user_verify_by_sms" <?php if ($this->system->user_verify_by_sms == 'Yes') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="user_verify_by_email" <?php if ($this->system->user_verify_by_email == 'Yes') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                            ...
                            <div class="tab-pane fade <?php if ($tab == "notificationSetting") {
                                                            echo 'show active';
                                                        } ?>" id="v-pills-notification_setting" role="tabpanel" aria-labelledby="v-pills-notification_setting-tab">
                                <div class="card shadow">
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="push_notification" <?php if ($this->system->push_notification == 'Yes') {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <br />
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" name="mail_notification" <?php if ($this->system->mail_notification == 'Yes') {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                        </label>
                            ...
                            <div class="tab-pane fade <?php if ($tab == "privacyPolicy") {
                                                            echo 'show active';
                                                        } ?>" id="v-pills-privacy_policy" role="tabpanel" aria-labelledby="v-pills-privacy_policy-tab">
                                <div class="card shadow">
                                    <div class="card-body">
