...
<?php if(isset($page)){ ?>
    ...
    <?php if($page == 'category_add' || $page == 'category_edit' || $page == 'serviceProvider_add' || $page == 'serviceProvider_edit' || 
            ...
            $page == 'settings_list' || $page == 'package_add' || $page == 'package_edit' || $page == 'profile_edit' || $page == 'driver_add' || $page == 'driver_edit' || 
            $page == 'vehicleType_add' || $page == 'vehicleType_edit'){ ?>
    ...
    <?php if($page == 'coWorker_add' || $page == 'coWorker_edit' || $page == 'service_add' || $page == 'service_edit' || $page == 'offer_add' || $page == 'offer_edit' ||
            ...
            $page == 'package_edit' || $page == 'package_add' || $page == 'dispatch_view' || $page == 'branch_add' || $page == 'branch_edit' || $page == 'driver_add' || 
            $page == 'driver_edit'){ ?>
