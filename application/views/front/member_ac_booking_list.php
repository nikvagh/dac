		...
		<li row-id="<?php echo $val->id; ?>">
			<div class="row flex-row">
				...
				<div class="col-md-3 text-right right-box">
					...
					<a class="btn btn-sm btn-pill btn-secondary" onclick="load_booking_view('<?php echo $val->id; ?>')" data-toggle="tooltip" data-placement="top" title="View Details"><i class="fa fa-eye"></i></a>
