                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <!-- <div class="text-right padding-10">
                                        <a href="<?php //echo base_url().SPPATH;?>job/add" class="btn btn-primary btn-sm">
                                            Add New Request
                                        </a>
                                    </div> -->

                                    <form name="datatableForm" id="datatableForm" action="<?=base_url().SPPATH;?>job" method="post" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                <?php $cnt1 = 1; foreach($manage_data as $data){ ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($data['sp_id'] == 0){ ?>
                                                                NOT ASSIGN <a href="<?php echo base_url().SPPATH."job/view/".$data['job_request_id']; ?>" class="btn btn-xs btn-warning btn-default">Click To Assign</a>
                                                            <?php }else{ ?>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url().SPPATH."job/view/".$data['job_request_id']; ?>" class="btn btn-info btn-sm">Manage</a>
                                                            <?php //if($data['status'] == 'Pending'){ ?>
                                                                <!-- <a href="<?php echo base_url().SPPATH;?>job/edit/<?php echo $data['job_id']; ?>" class="btn btn-info btn-sm">Edit</a> -->
