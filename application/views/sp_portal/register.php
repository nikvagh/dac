		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
                ...
                <h1 class="jumbotron" style="border-radius: 0px;padding-top:30px;padding-bottom:30px;">
                    JOIN DRIP AUTO CARE'S SERVICE PROVIDER NETWORK
                </h1>
                <br/>
				...
				<div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <form id="form1" class="" action="<?php echo base_url().SPPATH . 'register'; ?>" method="post" enctype="multipart/form-data">
            ...
            $("#form1").validate({
                ...
                rules: {
                    ...
                    username: {
                        ...
                        remote:
                        {
                            url: '<?php echo base_url().SPPATH . 'register/usernameCheck_add'; ?>',
                            type: "post",
                        }
                    },
                    email: {
                        ...
                        remote:
                        {
                            url: '<?php echo base_url().SPPATH . 'register/emailCheck_add'; ?>',
                            type: "post",
                        }
                    },
                    phone: {
