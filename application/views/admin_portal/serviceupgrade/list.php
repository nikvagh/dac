                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <div class="text-right padding-10">
                                        <a href="<?php echo base_url().ADMINPATH;?>serviceupgrade/add" class="btn btn-primary btn-sm">
                                            Add New Sevice
                                        </a>
                                    </div>

                                    <form name="datatableForm" id="datatableForm" action="<?=base_url().ADMINPATH;?>serviceupgrade" method="post" enctype="multipart/form-data">
                                        <table id="dt_basic" class="table table-striped" width="100%">
                                            ...
                                            <tbody>
                                                <?php foreach($manage_data as $data){ ?>
                                                    <tr>
                                                        <td><?php echo $data['service_upgrade_id']; ?></td>
                                                        <td><?php echo $data['title']; ?></td>
                                                        <td><?php echo '$ '.$data['amount']; ?></td>
                                                        <td><?php echo $data['status']; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url().ADMINPATH;?>serviceupgrade/edit/<?php echo $data['service_upgrade_id']; ?>" class="btn btn-info btn-sm">Edit</a>
                                                            <button type="button" class="btn btn-danger btn-sm" id="delete_<?php echo $data['service_upgrade_id']; ?>" onClick="javascript: confirmDelete('datatableForm','<?php echo $data['service_upgrade_id']; ?>')" >Delete</button>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
