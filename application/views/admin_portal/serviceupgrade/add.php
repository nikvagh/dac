                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                                    ...
                                                    //  print_r($profile);
                                                    ?>
                                        <form id="form1" class="smart-form" action="<?php echo base_url().ADMINPATH . 'serviceupgrade/add'; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <fieldset>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        <label>Amount *</label>
                                                        <input type="text" name="amount" placeholder="Service Price" value="">
                                                    </label>
                                                </section>
