                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                                    ...
                                                    //  print_r($profile);
                                                    ?>
                                        <form id="form1" class="smart-form" action="<?php echo base_url().ADMINPATH . 'membership/edit'; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <fieldset>
                                                <section>
                                                    <label class="input">
                                                        <label>Title *</label>
                                                        <input type="text" name="package_name" placeholder="Package Name" value="<?php echo $form_data['package_name']; ?>">
                                                    </label>
                                                </section>
                                                ...
                                                <section class="">
                                                    <label class="textarea">
                                                        ...
                                                        <textarea rows="3" name="package_description" placeholder="Description"><?php echo $form_data['package_description']; ?></textarea>
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        <label>Amount *</label>
                                                        <input type="text" name="package_amount" placeholder="Package Price" value="<?php echo $form_data['package_amount']; ?>">
                                                    </label>
                                                </section>
                                                    ...
                                                    <label class="select">
                                                        ...
                                                        <select name="package_validity">
                                                            ...
                                                            <?php foreach($membership_validity as $val){ ?>
                                                                <option value="<?php echo $val['membership_validity_id']; ?>" <?php if($form_data['package_validity'] == $val['membership_validity_id']){ echo "selected"; } ?>>
                                                                    <?php echo $val['text']; ?>    
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <section>
                                                    <div class="form-group">
                                                        ...
                                                        <select name="service_includes[]" id="service_includes" multiple class="select2">
                                                            <!-- <option value="">-- Select --</option> -->
                                                            <?php $services_old = explode(',',$form_data['service_includes']); ?>
                                            ...
                                            <footer>
                                                <input type="hidden" name="id" value="<?php echo $form_data['package_id']; ?>">
        ...
        <script type="text/javascript">
            ...
            $("#form1").validate({
                ...
                highlight: function(element) {
                    ...
                    //     $(element).siblings('.select2-container').children('.select2-selection').removeClass('state-success').addClass("state-error");
                ...
                unhighlight: function(element) {
                    // if(element.attr('id') && element.attr('id') == 'service_includes'){
                    //     $(element).sibling('.select2').removeClass("state-error").addClass('state-success');
