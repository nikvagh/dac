                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <div class="text-right padding-10">
                                        <a href="<?php echo base_url().ADMINPATH;?>job/add" class="btn btn-primary btn-sm">
                                            Add New Request
                                        </a>
                                    </div>

                                    <form name="datatableForm" id="datatableForm" action="<?=base_url().ADMINPATH;?>job" method="post" enctype="multipart/form-data">
                                        <table id="dt_basic" class="table table-striped" width="100%">
                                            <thead>
                                                <tr>
                                                    <th data-hide="phone"> #</th>
                                                    <th data-class="expand"> Member</th>
                                                    <th data-class="phone"> Location</th>
                                            ...
                                            <tbody>
                                                <?php $cnt1 = 1; foreach($manage_data as $data){ ?>
                                                    <tr>
                                                        <td><?php echo $cnt1; ?></td>
                                                        ...
                                                        <td>
                                                            <?php if($data['sp_id'] == 0){ ?>
                                                                NOT ASSIGN <a href="<?php echo base_url().ADMINPATH."job/view/".$data['job_request_id']; ?>" class="btn btn-xs btn-warning btn-default">Click To Assign</a>
                                                            <?php }else{ ?>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url().ADMINPATH."job/view/".$data['job_request_id']; ?>" class="btn btn-info btn-sm">View</a>
                                                            <?php if($data['status'] == '5'){ ?>
                                                                <a href="<?php echo base_url().ADMINPATH;?>job/invoice/<?php echo $data['job_request_id']; ?>" class="btn btn-primary btn-sm">Invoice</a>
                                                            <?php } ?>
