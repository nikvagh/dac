                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="box-body bg-color-gray">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone_day" placeholder="Day" value="" class="form-control">
                                                <br/>
                                                <input type="text" name="phone_night" placeholder="Night" value="" class="form-control">
                                                <br/>
                                                <input type="text" name="phone_cell" placeholder="Cell" value="" class="form-control">
                                            </div>
                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="owner_name" placeholder="Owner's Name" value="" class="form-control">
                                            </div>
