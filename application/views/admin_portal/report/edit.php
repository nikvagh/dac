    ...
    <body class="smart-style-1">
        ...
        <div id="main" role="main">
            ...
            <div id="content">
                ...
                <form id="form1" class="" action="<?php echo base_url().ADMINPATH . 'serviceprovider/edit'; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="box-body bg-color-gray">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone_day" placeholder="Day" value="<?php echo $form_data['phone_day']; ?>" class="form-control">
                                                <br/>
                                                <input type="text" name="phone_night" placeholder="Night" value="<?php echo $form_data['phone_night']; ?>" class="form-control">
                                                <br/>
                                                <input type="text" name="phone_cell" placeholder="Cell" value="<?php echo $form_data['phone_cell']; ?>" class="form-control">
                                            </div>
                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="owner_name" placeholder="Owner's Name" value="<?php echo $form_data['owner_name']; ?>" class="form-control">
                                            </div>
            ...
            $("#form1").validate({
                ...
                rules: {
                    ...
                    username: {
                        ...
                        remote:
                        {
                            url: '<?php echo base_url().ADMINPATH . 'serviceprovider/usernameCheck_edit'; ?>',
                            type: "post",
                            data:
                            {
                    ...
                    email: {
                        ...
                        remote:
                        {
                            url: '<?php echo base_url().ADMINPATH . 'serviceprovider/emailCheck_edit'; ?>',
                            type: "post",
                            data:
                            {
                            	id: function(){return $('#sp_id').val();}
