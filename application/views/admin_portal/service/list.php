                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <div class="text-right padding-10">
                                        <a href="<?php echo base_url().ADMINPATH;?>service/add" class="btn btn-primary btn-sm">
                                            Add New <?php echo $title; ?>
                                        </a>
                                    </div>

                                    <form name="datatableForm" id="datatableForm" action="<?=base_url().ADMINPATH;?>service" method="post" enctype="multipart/form-data">
                                            ...
                                            <tbody>
                                                <?php foreach($manage_data as $data){ ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url().ADMINPATH;?>service/edit/<?php echo $data['service_id']; ?>" class="btn btn-info btn-sm">Edit</a>
