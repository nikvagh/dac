                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="box-body bg-color-gray">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>Main Dispatch Number: <?php echo $form_data['phone_day']; ?></p>
                                                <p>Backup Dispatch Number: <?php echo $form_data['phone_night']; ?></p>
                                                <p>Owner / General manager cell: <?php echo $form_data['phone_cell']; ?></p>
                                            </div>
                                    ...
                                    <div class="box with-shadow">
                                        ...
                                        <div class="box-body bg-color-gray">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p><?php echo $form_data['owner_first_name']; ?></p>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">Owner's Last Name </label>
                                                <p><?php echo $form_data['owner_last_name']; ?></p>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label">More than one owner </label>
                                                <p><?php if($form_data['more_than_one_owner'] == "Y"){ echo "Yes"; }else{ echo "No"; } ?></p>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label">Mail Address is Diffrent ? </label>
                                                <p><?php if($form_data['owner_last_name'] == "Y"){ echo "Yes"; }else{ echo "No"; } ?></p>
                                            </div>
