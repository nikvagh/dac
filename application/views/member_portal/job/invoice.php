                                        ...
                                        <div class="box-header bg-color-teal txt-color-white">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-right">
                                                    <h5 class="">
                                                        <a href="<?php echo base_url().MEMBERPATH . 'job/download_invoice/'.$form_data['job_request_id']; ?>" class="btn btn-primary">Download</a>
                                                        <!-- <a href="<?php echo base_url().MEMBERPATH . 'job/email_invoice/'.$form_data['job_request_id']; ?>" class="btn btn-primary">Email To Customer</a> -->
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box-body">
                                            ...
                                            <div class="padding-10">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php $cnt1=1; if(!empty($services)){ ?>
                                                            <tr>
                                                                <td colspan="3" class="text-center">Services</td>
                                                            </tr>
                                                            <?php $total=0; foreach($services as $val){ ?>
                                                                <tr>
                                                        ...
                                                        <?php $total=0; if(!empty($featured_services)){ ?>
                                                            <tr>
                                                                <td colspan="3" class="text-center">Featured Services</td>
                                                            </tr>
                                                            <?php foreach($featured_services as $val){ ?>
                                                                <tr>
                                                                    <td class="text-center"><strong><?php echo $cnt1; ?></strong></td>
                                                                    <td><a><?php echo $val['title']; ?></a></td>
                                                                    <td>
