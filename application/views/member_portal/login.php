...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
						...
						<div class="well no-padding">
							<form action="<?php echo site_url(MEMBERPATH.'login/dologin/')?>" method="post" id="login-form" class="smart-form client-form">
								...
								<footer>
									...
									<br/><br/><br/>
									<a href="<?php echo $authURL; ?>"> <img src="<?php echo $this->assets; ?>img/login_fb.png" alt="" width="100%"> </a>
								</footer>
							</form>
		...
		<script>
			<div id="fb-root"></div>
			<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v8.0&appId=4560790820629572&autoLogAppEvents=1" nonce="ltaUqm78"></script>
		</script>
