                            ...
                            <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                                    ...
                                                    //  print_r($profile);
                                                    ?>
                                        <form id="form1" class="smart-form" action="<?php echo base_url().MEMBERPATH . 'paymentcard/add'; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <fieldset>
                                                <section>
                                                    <label class="input">
                                                        ...
                                                        <input type="text" name="name" placeholder="Name On Card" value="">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        ...
                                                        <input type="text" name="number" placeholder="Card Number" value="">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        ...
                                                        <input type="text" name="expiry_month" placeholder="Expiry Month" value="">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        ...
                                                        <input type="text" name="expiry_year" placeholder="Expiry Year" value="">
                                                    </label>
                                                </section>
                                                ...
                                                <section>
                                                    <label class="input">
                                                        <label>CVV *</label>
                                                        <input type="text" name="cvv" placeholder="CVV" value="">
                                                    </label>
                                                </section>
                                                <!-- <section>
                                                    <label class="select">
