        ...
        <div class="card bg-gradient-success">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm text-right font-weight-bold">
                    <a href="<?php echo base_url(MEMBER.'customer'); ?>" class="text-white"> View</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-3">
        <div class="card bg-gradient-primary">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm text-right font-weight-bold">
                    <a href="<?php echo base_url(MEMBER.'appointment'); ?>" class="text-white"> View</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-3">
        <div class="card bg-gradient-info">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm text-right font-weight-bold">
                    <a href="<?php echo base_url(MEMBER.'dispatch'); ?>" class="text-white"> View</a>
                </p>
            </div>
        </div>
    </div>
