...
<body class="clean-body" style="padding: 0; max-width: 800px;margin:auto;background-color: #f0f0f0;color: #000000">
    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          ...
          <div class="u-row-container" style="padding: 10px;background-color: #f0f0f0; background:#dfdfdf;">
                            ...
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family:'Open Sans',sans-serif" align="left">
                              ...
                              <div style="line-height: 120%; text-align: center; word-wrap: break-word;">
                                <div style="font-family: arial, helvetica, sans-serif;">
                                  <div>
                                    <span style="font-size: 14px; color: #999999; line-height: 14.4px;">Contact Inquiry Details</span>
                                  </div>
                                </div>
                              </div>
                ...
                <div class="u-col u-col-100"
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;">
                              <div style="color: #ffffff; word-wrap: break-word;">
                              
                                <table class="table contact-details" cellpadding="3" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td width="30%" class="">Name</td>
                                      <td class="text-left"><?php echo $form_data['name']; ?></td>
                                    </tr>
                                    <tr>
                                      <td width="30%" class="">Email</td>
                                      <td class="text-left"><?php echo $form_data['email']; ?></td>
                                    </tr>
                                    <tr>
                                      <td width="30%" class="">Phone</td>
                                      <td class="text-left"><?php echo $form_data['phone']; ?></td>
                                    </tr>
                                    <tr>
                                      <td width="30%" class="">Service Type</td>
                                      <td class="text-left"><?php echo $form_data['service_type']; ?></td>
                                    </tr>
                                    <tr>
                                      <td width="30%" class="">Message</td>
                                      <td class="text-left"><?php echo $form_data['message']; ?></td>
                                    </tr>
                                  </tbody>
                                </table>
                  ...
                  <div style="width: 100% !important;">
                    ...
                    <div
                      ...
                      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px;font-family:'Open Sans',sans-serif;">
                              <div style="color: #ffffff; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px;">
                                  <span style="text-decoration: underline; font-size: 16px;"><a href="<?php echo base_url(); ?>" style="color:#ffffff;text-decoration: none;">Drip Auto Care</a></span>
                                </p>
                              </div>
                            </td>
                          </tr>
